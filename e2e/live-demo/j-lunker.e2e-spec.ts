...
describe('plunker live demo', () => {
    ...
    describe('just test plunker live demo can open', () => {
        ...
        // demo index: 100
        it('testing http://rdkmaster.com/jigsaw/live-demo-temp/select/full/index.html', async () => {
        ...
        // demo index: 101
        it('testing http://rdkmaster.com/jigsaw/live-demo-temp/select/scroll/index.html', async () => {
